...
이 "서버 중개" 원칙은 향후 프레임워크 이주 방향(단순 SPA가 아니라 Next.js Server Actions)을 정하는 기준도 됐다. 현재 스택은 여전히 Streamlit이고, 이주는 결정 단계로 아직 실행 전이다. 상세는 [01-build-journey.md](01-build-journey.md) §4~5.
